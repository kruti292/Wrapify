...
<div class="col-sm-4 mydivstyleone text-center">
  <br>
<h2 class = "text-center headingfour" style = "font-family : Monotype Corsiva ; color : red"><?= $row[1]?></h2> 
<br>
<a href = "giftbycategory1.php?categoryid=<?=$row[0]?>&categoryname=<?=$row[1]?>"><img class='zoom' src="admin/<?=$row[2]?>" style = "border-radius : 50% ; width:350px; height : 250px"> </a> 
</div>
<?php 
}
?>
