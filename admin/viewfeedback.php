...
<h1 class= "text-center" style = "font-family : 'Monotype Corsiva' ; color : #e6120e">View Feedback</h1>
<?php 
...
echo "<td>$row[4]</td>";
echo "<td>$row[5]</td>";
echo "<td><a href='deletefeedback.php?id=$row[0]' class='btn btn-danger'>Delete</a></td>";
echo "</tr>";
}
echo "</tbody>";
echo "</table>";
