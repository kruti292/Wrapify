...
<h1 class= "text-center" style = "font-family : 'Monotype Corsiva' ; color : #e6120e">View Category</h1>
<?php 
...
echo "<td><a href='deletecategory.php?id=$row[0]' class='btn btn-danger'>Delete</a></td>";
echo "</tr>";
}
echo "</tbody>";
echo "</table>";
